...
export default function ItemCard(props: any) {
  return (
    <div className="bg-zinc-500  text-zinc-100 px-4 py-4 flex flex-col justify-center items-center rounded-xl">
      <Image
      ...
      <div className="mt-10 flex justify-center gap-x-8 w-full">
